...
import ReportPage from './views/admin/ReportPage';
            ...
            <Routes>
                <Route path="/" element={<Layout />}>
                    ...
                    <Route element={<RequireUser allowedRoles={['admin']} />}>
                        ...
                        <Route path="admin/users/create-user" element={<UserCreate />} />
                        <Route path="admin/users/update-user/:id" element={<UserUpdate />} />
