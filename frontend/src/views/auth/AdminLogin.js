...
import loginImg from '../../assets/img/admin-login.png';
...
const AdminLogin = () => {
    ...
    const [adminLoginUser, { isLoading, isError, error, isSuccess, data }] = useAdminLoginUserMutation();
            ...
            <div className="auth-inner row m-0">
                ...
                <div className="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                    <div className="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                        <h2 className="fw-bold mb-3" style={{ fontSize: '28px' }}>Admin</h2>
