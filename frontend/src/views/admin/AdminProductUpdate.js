...
const AdminProductUpdate = () => {
    ...
    useEffect(() => {
        if (product) {
            const fields = ['name', 'detail', 'stock', 'price', 'productImg', 'size', 'resolution'];
                                ...
                                <Row className="my-3">
                                    ...
                                    <Col md="7">
                                        ...
                                        <div className="mb-2">
                                            ...
                                            <select
                                                className={`form-control ${classnames({ 'is-invalid': errors.size })}`}
                                                id="size"
                                                name="size"
                                            ...
                                            {errors.size && <span className="text-danger">
                                                <small>Screen Size is required.</small></span>}
                                        </div>
                                        <div className="mb-2">
                                            <Label>Resolution</Label>
                                            <select
                                                className={`form-control ${classnames({ 'is-invalid': errors.resolution })}`}
                                                id="resolution"
                                                name="resolution"
                                            ...
                                            {errors.resolution && <span className="text-danger">
                                                <small>Resolution is required.</small></span>}
                                        </div>
                                        <div className="mt-4">
