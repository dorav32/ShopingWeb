                            ...
                            <Row>
                                ...
                                <Col md={8}>
                                    <Form onSubmit={handleSubmit(onSubmit)}>
                                        ...
                                        <div className="my-4">
                                            <Button color="outline-success" className=" btn-block mx-1" type="submit">
                                                Submit
                                            </Button>
                                            <Button color="outline-danger" className="btn-block mx-1" type="button" onClick={handleDeleteUser}>
                                                Delete Account
                                            </Button>
                                        </div>
                                    </Form>
